...
function DroneManagement() {
  ...
  const editFarmRequest = () => {
    axios
      .put(
        `${url}/api/pilot/edit/${currentFarm[0]._id}`,
        {
          name: name,
          phone: address,
          email: zipcode,
        ...
        <div className={styles["sidebar"]}>
          ...
          <div className={styles["options"]} style={{ cursor: "pointer" }}>
            <div
              ...
              onClick={() => (window.location = "/dashboard/farmer/management")}
            >
              Farmers Management
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/dashboard/drone/management")}
            >
              Drone Management
            </div>
            <div
              className={styles["option-select"]}
              onClick={() => (window.location = "/dashboard/pilot/management")}
            >
              Pilots Management
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/dashboard/farm/management")}
            >
              Farms Management
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/dashboard/drone/cloud/map")}
            >
              Drone Tracking
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/admin/cloudDashboard")}
            >
              Cloud Dashboard Status
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/admin/aimodels")}
            >
              AI Models
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/admin/arvrtracking")}
            >
              AR/VR Tracking
            </div>
            <div
              className={styles["option"]}
              onClick={() => (window.location = "/admin/statistics")}
            >
              Statistics
            </div>
          </div>
