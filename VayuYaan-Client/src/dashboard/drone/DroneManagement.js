...
function DroneManagement() {
  ...
  const deleteDrone = (id) => {
    axios
      .delete(`${url}/api/drone/delete/${id}`, {
        "Content-Type": "application/json",
      })
      .then(function (response) {
        console.log(response);
  ...
  const editDroneRequest = () => {
    axios
      .put(
        `${url}/api/drone/edit/${currentDrone[0]._id}`,
        {
          model: model,
          service: service,
          status: status,
                    ...
                    return (
                      <tr key={drone._id}>
                        ...
                        <td className={styles["operations"]}>
                          ...
                          <button onClick={() => deleteDrone(drone._id)}>
                            <img src={DeleteIcon} alt="delete" />
                          </button>
                          <button onClick={() => editDrone(drone._id)}>
